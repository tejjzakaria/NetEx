...
if (isset($_POST['submit'])) {
    ...
    $price = $_POST['price'];  // You can add a price field to your form if needed
    $state = 'unpaid';
    $status = 'new';

    // Prepare the SQL query
    $sql = "INSERT INTO parcels (userID, tracking_id, business, recipient, city, phone_number, product, address, comments, price, state, status)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param("ssssssssssss", $userID, $tracking_id, $business, $recipient, $city, $phone_number, $product, $address, $comments, $price, $state, $status);
...
$sql = "SELECT business FROM businesses";
$businessData = mysqli_query($conn, $sql);

$sql_ = "SELECT product_name FROM products";
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="addParcels.php">New Parcel</a>
                                        </li>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputtext"
                                            placeholder="John Deo" name="recipient" required>
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputtext"
                                            placeholder="Street name, postal code" name="address" required></textarea>
                                    </div>

                                    <div class="mb-4">
                                        <label for="exampleInputPassword1"
                                            class="form-label fw-semibold">State</label>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea type="text" name="comments" class="form-control" id="exampleInputtext"
                                            placeholder="Add extra info here" required></textarea>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center gap-3">
                                        <button type="submit" name="submit" class="btn btn-primary">Add parcel</button>
                                    </div>
                                </div>
                            </div>
                        </div>
