...
$sql = "SELECT * FROM stock_requests WHERE userID='$userID'";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $table_data = '
            <tr>
                ...
                <td>
                    <span
                        class="badge bg-light-primary text-primary fw-semibold fs-2 gap-1 d-inline-flex align-items-center"><i
                            class="ti ti-circle fs-3"></i>In stock</span>
                </td>
                <td>
                    <span
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="viewProducts.php">List Products</a>
                                        </li>
