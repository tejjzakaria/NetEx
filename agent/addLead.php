...
if (isset($_POST['submit'])) {
    ...
    // Prepare the SQL query to insert into leads
    ...
    $stmt->bind_param("ssssssssssss", $userID, $name, $tracking_id, $phone_number, $price, $city, $product, $address, $comments, $agent, $status, $product_comission);
...
$sql_ = "SELECT product_name FROM stock_requests WHERE userID='$userID'";
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center gap-3">
                                        <button type="submit" name="submit" class="btn btn-primary">Ajouter lead</button>
                                    </div>
                                </div>
                            </div>
                        </div>
