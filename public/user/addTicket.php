...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO support (user_id, agentName, subject, message, status)
            VALUES (?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param("sssss", $user_id, $agentName, $subject, $message, $status);
    if ($stmt->execute()) {
        // Success
        $alertScript = "
    <script>
        Swal.fire({
          title: 'Ticket ajouté', 
          text: 'Redirection vers la liste des ticket...',
          icon: 'success',
          timer: 3000,
            ...
            <div class="container-fluid">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="addTicket.php">Ajouter Ticket</a>
                                        </li>
                ...
                <form method="POST">
                    <div class="card">
                        ...
                        <input type="hidden" name="agentName" value="_">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputtext" readonly
                                            value="<?php echo $ticket_id; ?>" name="ticket_id" required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputtext"
                                            placeholder="Écrivez les détails ici" name="message" required></textarea>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputtext"
                                            placeholder="De quoi parle votre ticket ?" name="subject" required>
                                    </div>
