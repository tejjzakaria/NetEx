...
$id = $_GET['id'];
$sql = "SELECT * FROM businesses WHERE id='$id' AND userID='$userID'";
            ...
            <div class="container-fluid">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="viewBusinessDetails.php">Business Details</a>
                                        </li>
                ...
                <div class="row">
                    <div class="card shadow-none border">
                        <div class="card-body">
                            <h4 class="fw-semibold mb-3"><?php echo $businessData['business'] ?></h4>
                            <p class="mb-3"><?php echo $businessData['business_id'] ?></p>
                            <ul class="list-unstyled mb-0">
                                <li class="d-flex align-items-center gap-3 mb-4">
                                    <i class="ti ti-mail text-dark fs-6"></i>
                                    <h6 class="fs-4 mb-0"><?php echo $businessData['email'] ?></h6>
                                </li>
                                <li class="d-flex align-items-center gap-3 mb-4">
                                    <i class="ti ti-phone text-dark fs-6"></i>
                                    <h6 class="fs-4 mb-0"><?php echo $businessData['phone_number'] ?></h6>
                                </li>
                                <li class="d-flex align-items-center gap-3 mb-2">
                                    <i class="ti ti-map-pin text-dark fs-6"></i>
                                    <h6 class="fs-4 mb-0"><?php echo $businessData['address'] ?>,
                                        <?php echo $businessData['city'] ?>
                                    </h6>
                                </li>
                            </ul>
                            <div class="d-flex justify-content-lg-start align-items-center">
                                <a href="editBusiness.php?id=<?php echo $id; ?>"
                                    class="justify-content-center btn mt-4 btn-secondary d-flex align-items-center"
                                    style="margin-right: 10px;">Edit</a>

                                <a href="deleteBusiness.php?id=<?php echo $id; ?>"><button
                                    class="justify-content-center btn mt-4 btn-danger d-flex align-items-center">Delete</button></a>
                            </div>
                        </div>
