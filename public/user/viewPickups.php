...
$sql = "SELECT * FROM pickups WHERE userID='$userID'";
...
while ($row = mysqli_fetch_assoc($result)) {
    if ($row['status'] == 'success' or $row['status'] == 'active') {
        ...
        $status_class = "badge bg-light-primary text-danger fw-semibold fs-2 gap-1 d-inline-flex align-items-center";
    }
    else{
    ...
    $table_data = '
            <tr>
                <td>
                    <p class="mb-0 fw-normal">'. $row['pickup_id'] .'</p>
                </td>
                <td>
                    <span
                ...
                <td>
                    <p class="mb-0 fw-normal">'. $row['pickup_date'] .'</p>
                </td>
                <td>
                ...
                <td>
                    <div class="dropdown dropstart">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButto">
                            <li>
                                <a class="dropdown-item d-flex align-items-center gap-3" href="editPickup.php?id='. $row['id'] .'"><i
                                        class="fs-4 ti ti-edit"></i>Edit</a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center gap-3" href="deletePickup?id='. $row['id'] .'"><i
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="viewPickups.php">List Pickups</a>
                                        </li>
