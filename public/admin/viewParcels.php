...
$sql = "SELECT parcels2.*, user_info.full_name 
        FROM parcels2 
        JOIN user_info ON parcels2.userID = user_info.id ORDER BY id";
                ...
                <td>
                    <div class="dropdown dropstart">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButto"
                            <li>
                                <a class="dropdown-item d-flex align-items-center gap-3" href="editParcel.php?id=' . $row['id'] . '"><i
                                        class="fs-4 ti ti-edit"></i>Modifier</a>
                            </li>
                            <li>
                                <a class="dropdown-item d-flex align-items-center gap-3" href="deleteParcel.php?id=' . $row['id'] . '"><i
...
<body>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <div class="dataTables_wrapper">
                                            <table
                                                class="table border text-nowrap customize-table mb-0 align-middle dataTable"
                                                id="parcels_table">
    ...
    <script>
        ...
        $(".buttons-csv, .buttons-pdf").addClass("btn btn-outline-success mx-1");
