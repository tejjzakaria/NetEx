...
$userDataU = mysqli_fetch_assoc($result);
...
if (isset($_POST['submit'])) {
    ...
    $stmt->bind_param("ssssssssssi", $full_name, $cin, $email, $phone_number, $city, $address, $bank_name, $bank_account, $username, $status, $id);
    ...
    if ($stmt->execute()) {
        ...
        <script>
            Swal.fire({
              ...
              window.location.href = 'viewAgents.php'; // Redirect after the SweetAlert
            });
        </script>
        ";
    } else {
...
if (isset($_POST['submit-password'])) {
    ...
    if ($new_password !== $confirm_new_password) {
        ...
        $update_sql = "UPDATE agent_info SET password = ? WHERE id = ?";
...
<head>
    <!--  Title -->
    <title>Admin - Modifier Agent</title>
    <!--  Required Meta Tag -->
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="editAgent.php">Modifier Agent</a>
                                        </li>
                                                ...
                                                <form action="" method="POST">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control mt-2"
                                                                        ...
                                                                        value="<?php echo $userDataU['full_name'] ?>"
                                                                        required />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="email" class="form-control mt-2"
                                                                        ...
                                                                        value="<?php echo $userDataU['email'] ?>" />
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="tel" class="form-control mt-2"
                                                                        ...
                                                                        required
                                                                        value="<?php echo $userDataU['phone_number'] ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select"
                                                                        ...
                                                                        required>
                                                                        <option value="Casablanca" <?php echo ($userDataU['city'] == 'Casablanca') ? 'selected' : ''; ?>>Casablanca
                                                                        </option>
                                                                        <option value="Rabat" <?php echo ($userDataU['city'] == 'Rabat') ? 'selected' : ''; ?>>Rabat</option>
                                                                        <option value="Fes" <?php echo ($userDataU['city'] == 'Fes') ? 'selected' : ''; ?>>Fes</option>
                                                                        <option value="Marrakesh" <?php echo ($userDataU['city'] == 'Marrakesh') ? 'selected' : ''; ?>>Marrakesh</option>
                                                                        <option value="Tangier" <?php echo ($userDataU['city'] == 'Tangier') ? 'selected' : ''; ?>>Tangier</option>
                                                                        <option value="Agadir" <?php echo ($userDataU['city'] == 'Agadir') ? 'selected' : ''; ?>>Agadir</option>
                                                                        <option value="Meknes" <?php echo ($userDataU['city'] == 'Meknes') ? 'selected' : ''; ?>>Meknes</option>
                                                                        <option value="Oujda" <?php echo ($userDataU['city'] == 'Oujda') ? 'selected' : ''; ?>>Oujda</option>
                                                                        <option value="Kenitra" <?php echo ($userDataU['city'] == 'Kenitra') ? 'selected' : ''; ?>>Kenitra</option>
                                                                        <option value="Tetouan" <?php echo ($userDataU['city'] == 'Tetouan') ? 'selected' : ''; ?>>Tetouan</option>
                                                                        <option value="Safi" <?php echo ($userDataU['city'] == 'Safi') ? 'selected' : ''; ?>>Safi</option>
                                                                        <option value="Khouribga" <?php echo ($userDataU['city'] == 'Khouribga') ? 'selected' : ''; ?>>Khouribga</option>
                                                                        <option value="El Jadida" <?php echo ($userDataU['city'] == 'El Jadida') ? 'selected' : ''; ?>>El Jadida</option>
                                                                        <option value="Nador" <?php echo ($userDataU['city'] == 'Nador') ? 'selected' : ''; ?>>Nador</option>
                                                                        <option value="Beni Mellal" <?php echo ($userDataU['city'] == 'Beni Mellal') ? 'selected' : ''; ?>>Beni Mellal</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control mt-2"
                                                                        ...
                                                                        value="<?php echo $userDataU['address'] ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select mt-2"
                                                                        ...
                                                                        <option value="CIH Bank" <?php echo ($userDataU['bank_name'] == 'CIH Bank') ? 'selected' : ''; ?>>CIH Bank</option>
                                                                        <option value="BMCE Bank" <?php echo ($userDataU['bank_name'] == 'BMCE Bank') ? 'selected' : ''; ?>>BMCE Bank</option>
                                                                        <option value="BMCI Bank" <?php echo ($userDataU['bank_name'] == 'BMCI Bank') ? 'selected' : ''; ?>>BMCI Bank</option>
                                                                        <option value="ATTIJARIWAFA Bank" <?php echo ($userDataU['bank_name'] == 'ATTIJARIWAFA Bank') ? 'selected' : ''; ?>>ATTIJARIWAFA
                                                                            Bank</option>
                                                                        <option value="Banque populaire" <?php echo ($userDataU['bank_name'] == 'Banque populaire') ? 'selected' : ''; ?>>Banque Populaire
                                                                        </option>
                                                                        <option value="Barid Bank" <?php echo ($userDataU['bank_name'] == 'Barid Bank') ? 'selected' : ''; ?>>Barid Bank</option>
                                                                        <option value="Credit De Maroc" <?php echo ($userDataU['bank_name'] == 'Credit De Maroc') ? 'selected' : ''; ?>>Credit De Maroc
                                                                        </option>
                                                                        <option value="Other" <?php echo ($userDataU['bank_name'] == 'Other') ? 'selected' : ''; ?>>Autre</option>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control mt-2"
                                                                        ...
                                                                        value="<?php echo $userDataU['bank_account'] ?>" />
                                                                </div>
                                                            </div>
                                                    ...
                                                    <section>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control mt-2"
                                                                        ...
                                                                        value="<?php echo $userDataU['username'] ?>" />
                                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    <label for="emailAddress1">Statut*</label>
                                                                    <select class="form-select"
                                                                        aria-label="Default select example" name="status"
                                                                        required>
                                                                        <option value="ACTIVE" <?php echo ($userDataU['status'] == 'ACTIVE') ? 'selected' : ''; ?>>ACTIVE
                                                                        </option>
                                                                        <option value="INACTIVE" <?php echo ($userDataU['status'] == 'INACTIVE') ? 'selected' : ''; ?>>INACTIVE</option>
                            ...
                            <div class="col-lg-9">
                                <div class="card">
                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <form action="" method="POST">
                                            <input type="hidden" name="id" value="<?php echo $userDataU['id'] ?>">
                                            <section>
                                                <div class="row">
