...
if (isset($_GET['id'])) {
    ...
    // Fetch existing offer data from the database
    ...
    if ($stmt = $conn->prepare($sql)) {
        ...
        $message = "<div class='alert alert-danger'>Error: Could not fetch offer data.</div>";
    }
}
...
if (isset($_POST['submit'])) {
    ...
    $offer_comission = $_POST['offer_comission'];
    $link = $_POST['link'];
    ...
    if ($stmt->execute()) {
        ...
        <script>
            Swal.fire({
              ...
              text: 'Redirection vers la liste des offres...',
              icon: 'success',
              timer: 3000, // Time in milliseconds (3 seconds)
              showConfirmButton: false
            }).then(() => {
              window.location.href = 'offers.php'; // Redirect after the SweetAlert
            });
        </script>
        ";
    } else {
...
<head>
    <!--  Title -->
    <title>Admin - Modifier Offre</title>
    <!--  Required Meta Tag -->
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="">Modifier Offre</a>
                                        </li>
                ...
                <div class="card">
                    ...
                    <div class="card-body wizard-content">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            <section>
                                <input type="hidden" name="id" value="<?php echo $offerData['id']; ?>">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="firstName1">Nom offre*</label>
                                            <input type="text" class="form-control mt-2" id="firstName1"
                                                name="offer_name" placeholder="Entrer le nom d'offre"
                                                value="<?php echo $offerData['offer_name']; ?>" required />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="phoneNumber1">Lien*</label>
                                            <input type="text" class="form-control mt-2" id="phoneNumber1" name="link"
                                                placeholder="Entrer lien d'offre" required
                                                value="<?php echo $offerData['link']; ?>" />
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="emailAddress1">Quantité*</label>
                                            <input type="number" class="form-control mt-2" id="emailAddress1"
                                                name="offer_quantity" placeholder="Entrer la quantité"
                                                value="<?php echo $offerData['offer_quantity']; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="emailAddress1">Image d'offre*</label>
                                            <input type="file" class="form-control mt-2" id="emailAddress1"
                                                name="f_image" placeholder="Image d'offre ici" value="<?php echo $offerData['f_image']; ?>"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select name="status" class="form-control mt-2" required>
                                                <option value="Active" <?php echo ($offerData['status'] == 'Active') ? 'selected' : ''; ?>>Active</option>
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <button type="submit" name="submit" class="btn btn-primary mt-4">Modifier offre</button>
                            </div>
