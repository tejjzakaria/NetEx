...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO products (userID, business, product_id, product_name, product_type, product_description, status)
            VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param("ssssssss", $userID, $business, $product_id, $product_name, $product_type, $product_description, $comments, $status);
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="addProducts.php">New Product</a>
                                        </li>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputtext"
                                            placeholder="Product information here" name="product_description" required></textarea>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputtext" readonly
                                            value="<?php echo $product_id?>" name="product_id" required>
                                    </div>
                                    <div class="mb-4">
                                        <label for="" class="form-label fw-semibold">Product Type</label>
