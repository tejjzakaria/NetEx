...
$id = $_GET['id'];
$sql = "SELECT * FROM pickups WHERE id='$id'";
$result = mysqli_query($conn, $sql);
$pickupData = mysqli_fetch_assoc($result);

$selectedUserID = $pickupData['userID'];  // Retrieve this from your parcel data
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE pickups SET userID='$userID', pickup_date='$pickup_date', pickup_id='$pickup_id',
type='$type', city='$city', address='$address', comments='$comments', status='$status' WHERE id='$id'";
                ...
                <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                    <div class="card-body px-4 py-3">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h4 class="fw-semibold mb-8">Pickups</h4>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="addPickup.php">Edit Pickup</a>
                                        </li>
                ...
                <form method="POST">
                    <div class="card">
                        ...
                        <div class="card-body p-4 border-bottom">
                            ...
                            <div class="row">
                                <input type="hidden" name="id" value="<?php echo $pickupData['id']; ?>">
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        <label for="" class="form-label fw-semibold">Pickup date</label>
                                        <input type="date" class="form-control" id="exampleInputtext"
                                            placeholder="Choose a date" name="pickup_date"
                                            value="<?php echo $pickupData['pickup_date'] ?>" required>
                                    </div>
                                    <div class="mb-4">
                                        <label for="" class="form-label fw-semibold">Type</label>
                                        <select class="form-select" aria-label="Default select example" name="type"
                                            required>
                                            <option value="Package" <?php echo ($pickupData['type'] == 'Package') ? 'selected' : ''; ?>>Package</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputtext" name="address"
                                            placeholder="Address here"
                                            required><?php echo $pickupData['address'] ?></textarea>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label fw-semibold">Pickup
                                            ID</label>
                                        <input type="text" class="form-control" id="exampleInputtext" name="pickup_id"
                                            readonly value="<?php echo $pickupData['pickup_id'] ?>" required>
                                    </div>
                                    <div class="mb-4">
                                        <label for="" class="form-label fw-semibold">City</label>
                                        <select class="form-select" aria-label="Default select example" name="city"
                                            required>
                                            <option value="Casablanca" <?php echo ($pickupData['city'] == 'Casablanca') ? 'selected' : ''; ?>>Casablanca</option>
                                            <option value="Rabat" <?php echo ($pickupData['city'] == 'Rabat') ? 'selected' : ''; ?>>Rabat</option>
                                            <option value="Fes" <?php echo ($pickupData['city'] == 'Fes') ? 'selected' : ''; ?>>Fes</option>
                                            <option value="Marrakesh" <?php echo ($pickupData['city'] == 'Marrakesh') ? 'selected' : ''; ?>>Marrakesh</option>
                                            <option value="Tangier" <?php echo ($pickupData['city'] == 'Tangier') ? 'selected' : ''; ?>>Tangier</option>
                                            <option value="Agadir" <?php echo ($pickupData['city'] == 'Agadir') ? 'selected' : ''; ?>>Agadir</option>
                                            <option value="Meknes" <?php echo ($pickupData['city'] == 'Meknes') ? 'selected' : ''; ?>>Meknes</option>
                                            <option value="Oujda" <?php echo ($pickupData['city'] == 'Oujda') ? 'selected' : ''; ?>>Oujda</option>
                                            <option value="Kenitra" <?php echo ($pickupData['city'] == 'Kenitra') ? 'selected' : ''; ?>>Kenitra</option>
                                            <option value="Tetouan" <?php echo ($pickupData['city'] == 'Tetouan') ? 'selected' : ''; ?>>Tetouan</option>
                                            <option value="Safi" <?php echo ($pickupData['city'] == 'Safi') ? 'selected' : ''; ?>>Safi</option>
                                            <option value="Khouribga" <?php echo ($pickupData['city'] == 'Khouribga') ? 'selected' : ''; ?>>Khouribga</option>
                                            <option value="El Jadida" <?php echo ($pickupData['city'] == 'El Jadida') ? 'selected' : ''; ?>>El Jadida</option>
                                            <option value="Nador" <?php echo ($pickupData['city'] == 'Nador') ? 'selected' : ''; ?>>Nador</option>
                                            <option value="Beni Mellal" <?php echo ($pickupData['city'] == 'Beni Mellal') ? 'selected' : ''; ?>>Beni Mellal</option>
                                        </select>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputtext"
                                            placeholder="Add extra info here" name="comments"
                                            required><?php echo $pickupData['comments'] ?></textarea>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="status"
                                            required>
                                            <option value="pending" <?php echo ($pickupData['status'] == 'pending') ? 'selected' : ''; ?>>pending</option>
                                            <option value="failed" <?php echo ($pickupData['status'] == 'failed') ? 'selected' : ''; ?>>failed</option>
                                            <option value="successful" <?php echo ($pickupData['status'] == 'successful') ? 'selected' : ''; ?>>successful</option>
