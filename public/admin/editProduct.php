...
$id = $_GET['id'];
$sql = "SELECT * FROM stock_requests WHERE id='$id'";
$result = mysqli_query($conn, $sql);
$stockData = mysqli_fetch_assoc($result);

$alertScript = "";

$selectedUserID = $stockData['userID'];  // Retrieve this from your parcel data
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE stock_requests SET userID='$userID', product_name='$product_name', quantity='$quantity',
product_category='$product_category', product_price='$product_price', product_comission='$product_comission', status='$status' WHERE id='$id'";
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        <script>
            Swal.fire({
              title: 'Info du stock modifié', 
              text: 'Redirection vers la liste des produits...',
              icon: 'success',
              timer: 3000, // Time in milliseconds (3 seconds)
              showConfirmButton: false
            }).then(() => {
              window.location.href = 'viewProducts.php'; // Redirect after the SweetAlert
            });
        </script>
        ";
    } else {
...
$sql_ = "SELECT offer_name FROM offers";
$offerData = mysqli_query($conn, $sql_);
...
<head>
    <!--  Title -->
    <title>Admin - Modifier Stock</title>
    <!--  Required Meta Tag -->
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="">Modifier Stock</a>
                                        </li>
                        ...
                        <div class="card-body p-4 border-bottom">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        <label for="" class="form-label fw-semibold">Offre</label>
                                        <select class="form-select" aria-label="Default select example" name="product_name"
                                            required>
                                            <?php
                                            // Loop through the products and create options
                                            while ($row = mysqli_fetch_assoc($offerData)) {
                                                $offer_name = htmlspecialchars($row['offer_name']); // Sanitize output
                                                // Check if this product is the one selected for the parcel
                                                $selected = ($offer_name == $stockData['product_name']) ? 'selected' : '';
                                                echo "<option value='$offer_name' $selected>$offer_name</option>";
                                            }
                                            ?>
                                    ...
                                    <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label fw-semibold">Quantité</label>
                                        <input type="number" class="form-control" id="exampleInputtext"
                                            value="<?php echo $stockData['quantity'] ?>" name="quantity"
                                            required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" class="form-control" id="exampleInputtext"
                                            value="<?php echo $stockData['product_price'] ?>" name="product_price"
                                            required>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label fw-semibold">Product
                                            Commission</label>
                                        <input type="text" class="form-control" id="exampleInputtext"
                                            value="<?php echo $stockData['product_comission'] ?>" name="product_comission" required>
                                    </div>
                                    <div class="mb-4">
                                    <label for="lastName1">Catégorie</label>
                                            <select name="product_category" class="form-control mt-2" required>
                                                <option value="Electronique" <?php echo ($stockData['product_category'] == 'Electronique') ? 'selected' : ''; ?>>Electronique</option>
                                                <option value="Vêtements" <?php echo ($stockData['product_category'] == 'Vêtements') ? 'selected' : ''; ?>>Vêtements</option>
                                                <option value="Maison" <?php echo ($stockData['product_category'] == 'Maison') ? 'selected' : ''; ?>>Maison</option>
                                                <option value="Beauté" <?php echo ($stockData['product_category'] == 'Beauté') ? 'selected' : ''; ?>>Beauté</option>
                                                <option value="Jouets" <?php echo ($stockData['product_category'] == 'Jouets') ? 'selected' : ''; ?>>Jouets</option>
                                                <option value="Livres" <?php echo ($stockData['product_category'] == 'Livres') ? 'selected' : ''; ?>>Livres</option>
                                                <option value="Sport" <?php echo ($stockData['product_category'] == 'Sport') ? 'selected' : ''; ?>>Sport</option>
                                                <option value="Automobile" <?php echo ($stockData['product_category'] == 'Automobile') ? 'selected' : ''; ?>>Automobile</option>
                                                <option value="Bijoux" <?php echo ($stockData['product_category'] == 'Bijoux') ? 'selected' : ''; ?>>Bijoux</option>
                                                <option value="Autre" <?php echo ($stockData['product_category'] == 'Autre') ? 'selected' : ''; ?>>Autre</option>
                                    ...
                                    <label for="exampleInputPassword1" class="form-label fw-semibold">Status</label>
                                        <select class="form-select" aria-label="Default select example" name="status"
                                            required>
                                            <option value="En attente" <?php echo ($stockData['status'] == 'En attente') ? 'selected' : ''; ?>>En attente</option>
                                            <option value="En stock" <?php echo ($stockData['status'] == 'En stock') ? 'selected' : ''; ?>>En stock</option>
                                            <option value="Echoué" <?php echo ($stockData['status'] == 'Echoué') ? 'selected' : ''; ?>>Echoué</option>
