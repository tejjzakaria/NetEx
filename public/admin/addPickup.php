...
$pickup_id = strtoupper(substr(md5(uniqid(rand(), true)), 0, 10));
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO pickups (userID, pickup_date, pickup_id, type, city, address, comments, status)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param("ssssssss", $userID, $pickup_date, $pickup_id, $type, $city, $address, $comments, $status);
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="addPickup.php">New Pickup</a>
                                        </li>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="date" class="form-control" id="exampleInputtext" placeholder="Choose a date" name="pickup_date" required>
                                    </div>
                                    <div class="mb-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label fw-semibold">Pickup
                                            ID</label>
                                        <input type="text" class="form-control" id="exampleInputtext" name="pickup_id" readonly
                                            value="<?php echo $pickup_id ?>" required>
                                    </div>
                                    <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center gap-3">
                                        <button type="submit" name="submit" class="btn btn-primary">Schedule pickup</button>
                                    </div>
                                </div>
                            </div>
                        </div>
