                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="viewProfile.php">Account</a>
                                        </li>
                                                ...
                                                <form>
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            ...
                                                            <div class="mb-4">
                                                                <label for="exampleInputPassword1"
                                                                    class="form-label fw-semibold">Payment mode</label>
                                                                <select class="form-select"
                                                                    aria-label="Default select example">
                                                                    <option value="Casablanca">CIH</option>
                                                                    <option value="Rabat">Attijari</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="mb-4">
                                                                <label for="exampleInputPassword1"
                                                                    class="form-label fw-semibold">C.I.N</label>
                                                                <input type="text" class="form-control"
                                                            ...
                                                            <div class="mb-4">
                                                                ...
                                                                <input type="email" class="form-control"
                                                                    id="exampleInputtext" placeholder="Email address">
                                                            </div>
                                                            <div class="mb-4">
                                                                <label for="exampleInputPassword1"
                                                                    class="form-label fw-semibold">Phone</label>
                                                                <input type="text" class="form-control"
                                                                    id="exampleInputtext" placeholder="06 00 00 00 00">
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="">
