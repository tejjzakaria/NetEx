...
// Prepare SQL query to get pickups, ordered by pickup_id (latest first)
$sql = "SELECT pickups.*, users.full_name 
        FROM pickups 
        JOIN users ON pickups.userID = users.id
        ORDER BY pickups.pickup_id DESC
        LIMIT ?";
...
while ($row = $result->fetch_assoc()) {
    ...
    $status_class = '';
    if ($row['status'] == 'success' || $row['status'] == 'active' || $row['status'] == 'Completed') {
    ...
    $table_data .= '
        <tr>
            ...
            <td>
                <span class="'. $status_class .'"><i class="ti ti-circle fs-3"></i>'. $row['status'] .'</span>
            </td>
            <td>
            ...
            <td>
                <div class="dropdown dropstart">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-3" href="editPickup.php?id='. $row['pickup_id'] .'">
                                <i class="fs-4 ti ti-edit"></i>Edit
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-3" href="deletePickup.php?id='. $row['pickup_id'] .'">
