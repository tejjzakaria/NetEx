...
$business_id = strtoupper(substr(md5(uniqid(rand(), true)), 0, 10));
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO businesses (userID, business, business_id, phone_number, email, business_type, city, address, comments)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param("sssssssss", $userID, $business, $business_id, $phone_number, $email, $business_type, $city, $address, $comments);
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="addBusiness.php">New Business</a>
                                        </li>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputtext"
                                            placeholder="Business Name" name="business" required>
                                    </div>
                                    <div class="mb-4">
                                        <label for="" class="form-label fw-semibold">Phone N°</label>
                                        <input type="text" class="form-control" id="exampleInputtext"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="business_type" required>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputtext"
                                            placeholder="Address here" name="address" required></textarea>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputtext" readonly
                                            value="<?php echo $business_id ?>" name="business_id" required>
                                    </div>
                                    <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center gap-3">
                                        <button class="btn btn-primary" type="submit" name="submit" >Add business</button>
                                    </div>
                                </div>
                            </div>
                        </div>
