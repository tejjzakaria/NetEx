...
$notification_id = strtoupper(substr(md5(uniqid(rand(), true)), 0, 10));
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO notifications (userID, message, status)
            VALUES (?, ?, ?)";
    ...
    $stmt->bind_param("sss", $userID, $message, $status);
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="addNotification.php">Nouveau Notification</a>
                                        </li>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputtext"
                                            name="notification_id" readonly value="<?php echo $notification_id ?>"
                                            required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center gap-3">
                                        <button type="submit" name="submit" class="btn btn-primary">Envoyer
                                            Notification</button>
                                    </div>
                                </div>
                            </div>
