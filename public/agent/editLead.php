    ...
    if (mysqli_query($conn, $sql)) {
        ...
        <script>
            Swal.fire({
              ...
              window.location.href = 'viewLeads.php';
            });
        </script>
        ";
    } else {
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="editLead.php">Modifier Lead</a>
                                        </li>
                ...
                <form method="POST" id="leadForm">
                    <div class="card">
                        <div class="card-body p-4 border-bottom">
                            <?php echo $message; ?>
                            <input type="hidden" id="successFlag" value="<?php echo $success ? '1' : '0'; ?>">
                            <div class="row">
                                <div class="col-lg-6">
                                    <input type="hidden" name="id" value="<?php echo $leadData['id']; ?>">

                                    <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label fw-semibold">ID</label>
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center gap-3">
                                        <button type="submit" name="submit" class="btn btn-primary"
                                            id="lead-success">Modifier lead</button>
                                    </div>
                                </div>
                            </div>
                        </div>
