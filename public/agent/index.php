...
if (isset($_POST['submit'])) {
  ...
  $stmt = $conn->prepare("SELECT id, username, password, status FROM agent_info WHERE username = ?");
...
<head>
  <!--  Title -->
  <title>Agent - Se connecter</title>
  <!--  Required Meta Tag -->
            ...
            <div class="card mb-0">
              <div class="card-body">
                ...
                <div class="position-relative text-center my-4">
                  <p class="mb-0 fs-4 px-3 d-inline-block bg-white text-dark z-index-5 position-relative">Connexion de l'agent</p>
