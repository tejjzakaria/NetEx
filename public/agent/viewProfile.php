...
if (isset($_POST['submit'])) {
    // Get form data
    $id = $_POST['id']; // Get the user ID from the URL
    ...
    $stmt->bind_param("ssssssssssi", $full_name, $cin, $email, $phone_number, $city, $address, $bank_name, $bank_account, $username, $hashed_password, $id);
                ...
                <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                    <div class="card-body px-4 py-3">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h4 class="fw-semibold mb-8">Utilisateur</h4>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="editUser.php">Modifier l'utilisateur</a>
                                        </li>
                                    ...
                                    <div class="col-12">
                                        <div class="card w-100 position-relative overflow-hidden mb-0">
                                            <div class="card-body p-4">
                                                ...
                                                <p class="alert alert-danger">Vous ne pouvez pas modifier vos informations vous-même, vous devez contacter l'administrateur!</p>
                                                <form action="" method="POST">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <select class="form-select mt-2"
                                                                        ...
                                                                        <option value="ATTIJARIWAFA Bank" <?php echo ($userData['bank_name'] == 'ATTIJARIWAFA Bank') ? 'selected' : ''; ?>>ATTIJARIWAFA
                                                                            Bank</option>
                                                                        <option value="Banque populaire" <?php echo ($userData['bank_name'] == 'Banque populaire') ? 'selected' : ''; ?>>Banque
                                                                            Populaire</option>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="password" class="form-control mt-2"
                                                                        id="int1" placeholder="Entrer un mot de passe"
                                                    ...
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <button type="submit" name="submit"
                                                            class="btn btn-primary mt-4">Modifier client</button>
                                                    </div>
-->
