...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['spreadsheet_id'])) {
    ...
    if (!$userID) {
        $alertScript = "<script>
            Swal.fire({
                title: 'Erreur!',
                text: 'Vous devez être connecté pour ajouter des feuilles de calcul.',
                icon: 'error',
    ...
    if ($inserted > 0) {
        $alertScript = "<script>
            Swal.fire({
                title: 'Feuilles ajoutées!',
                text: 'Redirection vers la liste des feuilles...',
                icon: 'success',
                timer: 3000,
        ...
        $alertScript = "<script>
            Swal.fire({
                title: 'Erreur!',
                text: 'Aucune feuille de calcul ajoutée.',
                icon: 'error',
                confirmButtonText: 'OK'
            });
        </script>";
...
<body>
                ...
                <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                    <div class="card-body px-4 py-3">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h4 class="fw-semibold mb-8">Google Sheets</h4>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="viewSheet.php">Ajouter feuilles de calcul</a>
                                        </li>
                    ...
                    <ul class="nav nav-pills user-profile-tab" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button
                                ...
                                <span class="d-none d-md-block">Feuilles de calcul</span>
                            </button>
                        </li>
                                                ...
                                                <form action="" method="POST">
                                                    <section id="spreadsheet-fields">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="mb-3">
                                                                    <label for="spreadsheet_1">ID Feuille de calcul
                                                                        1*</label>
                                                                    <input type="text" class="form-control mt-2"
                                                                        id="spreadsheet_1" name="spreadsheet_id[]"
                                                                        placeholder="Entrer feuille de calcul ID" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </section>
                                                    ...
                                                    <button type="button" class="btn btn-secondary mt-3"
                                                        id="add-spreadsheet">Ajouter plus</button>

                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <button type="submit" name="submit"
                                                            class="btn btn-primary mt-4">Ajouter feuilles</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
    ...
    <script>
        document.getElementById("add-spreadsheet").addEventListener("click", function () {
            let container = document.getElementById("spreadsheet-fields");
            let index = container.getElementsByTagName("input").length + 1;
        ...
        <div class="col-md-6">
            <div class="mb-3">
                <label for="spreadsheet_${index}">ID Feuille de calcul ${index}*</label>
                <input type="text" class="form-control mt-2" id="spreadsheet_${index}" name="spreadsheet_id[]" 
                    placeholder="Entrer feuille de calcul ID" />
            </div>
        </div>
    `;
