...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE parcels SET userID='$userID', business='$business', tracking_id='$tracking_id',
recipient='$recipient', city='$city', phone_number='$phone_number', product='$product', 
address='$address', comments='$comments' WHERE id='$id'";
...
$sql = "SELECT business FROM businesses WHERE userID='$userID'";
$businessData = mysqli_query($conn, $sql);

$sql_ = "SELECT product_name FROM products WHERE userID='$userID'";
                ...
                <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                    <div class="card-body px-4 py-3">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h4 class="fw-semibold mb-8">Parcels</h4>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="editParcel.php">Edit Parcel</a>
                                        </li>
                                        <li class="breadcrumb-item" aria-current="page">Edit exisiting</li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-3">
                        ...
                        <div class="card-body p-4 border-bottom">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        <label for="" class="form-label fw-semibold">Business</label>
                                        <select class="form-select" aria-label="Default select example" name="business"
                                            required>
                                            <?php
                                            // Loop through the businesses and create options
                                            while ($row = mysqli_fetch_assoc($businessData)) {
                                                $business = htmlspecialchars($row['business']); // Sanitize output
                                                // Check if this business is the one selected for the parcel
                                                $selected = ($business == $parcelData['business']) ? 'selected' : '';
                                    ...
                                    <div class="mb-4">
                                        <label for="exampleInputPassword1"
                                            class="form-label fw-semibold">Recipient</label>
                                        <input type="text" class="form-control" id="exampleInputtext"
                                            value="<?php echo $parcelData['recipient'] ?>" placeholder="John Deo"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputtext"
                                            ...
                                            value="<?php echo $parcelData['phone_number'] ?>" name="phone_number"
                                            required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputtext"
                                            placeholder="Street name, postal code" name="address"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputtext" readonly
                                            value="<?php echo $parcelData['tracking_id'] ?>" name="tracking_id"
                                            required>
                                    </div>
                                    <div class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        <label for="" class="form-label fw-semibold">Product</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center gap-3">
                                        <button type="submit" name="submit" class="btn btn-primary">Edit parcel</button>
                                    </div>
                                </div>
                            </div>
                        </div>
