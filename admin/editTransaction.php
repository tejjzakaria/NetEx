...
$selectedUserID = $transactionData['userID'];  // Retrieve this from your parcel data
$message = "";
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE withdrawal_requests SET userID='$userID', tracking_id='$tracking_id',
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="addTransaction.php">Modifier Transaction</a>
                                        </li>
