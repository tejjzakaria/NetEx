...
$ticket_id = strtoupper(substr(md5(uniqid(rand(), true)), 0, 10));
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE support SET subject='$subject',
...
if (mysqli_query($conn, $sql)) {
    ...
    <script>
        Swal.fire({
          ...
          text: 'Redirection vers la liste des tickets...',
          icon: 'success',
          timer: 3000,
            ...
            <div class="container-fluid">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted ">Modifier Ticket</a>
                                        </li>
                ...
                <form method="POST">
                    <div class="card">
                        ...
                        <input type="hidden" name="user_id" value="_">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="status"
                                            required>
                                            <option value="Nouveau" <?php echo ($ticketData['status'] == 'Nouveau') ? 'selected' : ''; ?>>Nouveau</option>
                                            <option value="En attente" <?php echo ($ticketData['status'] == 'En attente') ? 'selected' : ''; ?>>En attente</option>
                                            <option value="Résolue" <?php echo ($ticketData['status'] == 'Résolue') ? 'selected' : ''; ?>>Résolue</option>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputtext"
                                            placeholder="Écrivez les détails ici" name="message" required><?php echo $ticketData['message']?></textarea>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label fw-semibold">Sujet</label>
                                        <input type="text" class="form-control" id="exampleInputtext"
                                            placeholder="De quoi parle votre ticket ?" name="subject" value="<?php echo $ticketData['subject']?>" required>
                                    </div>
