    ...
    if (isset($_FILES['csvFile']) && $_FILES['csvFile']['error'] == 0) {
        ...
        if ($file !== FALSE) {
            ...
            while (($row = fgetcsv($file, 1000, ',')) !== FALSE) {
                ...
                $sql = "INSERT INTO leads (userID, tracking_id, name, phone_number, city, product, agent, status, price, address, comments, comission) 
                        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                ...
                $stmt->bind_param("ssssssssssss", $userID, $tracking_id, $name, $phone_number, $city, $product, $agent, $status, $price, $address, $comments, $comission);
                if (!$stmt->execute()) {
...
<head>
    <!--  Title -->
    <title>Admin - Importer Lead</title>
    <!--  Required Meta Tag -->
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="import_lead.php">Ajouter Lead</a>
                                        </li>
                                        <li class="breadcrumb-item" aria-current="page">Importer lead</li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-3">
