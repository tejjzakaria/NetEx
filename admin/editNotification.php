...
$userDataN = mysqli_query($conn, $sql_);
...
$selectedUserID = $notificationData['userID'];  // Retrieve this from your parcel data
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE notifications SET userID='$userID', message='$message' WHERE id='$id'";
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        <script>
            Swal.fire({
              title: 'Notification modifié', 
              text: 'Redirection vers la liste des notifications...',
              icon: 'success',
              timer: 3000, // Time in milliseconds (3 seconds)
              showConfirmButton: false
            }).then(() => {
              window.location.href = 'viewNotifications.php'; // Redirect after the SweetAlert
            });
        </script>
        ";
    } else {
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="">Modifier Notification</a>
                                        </li>
                ...
                <form method="POST">
                    <div class="card">
                        ...
                        <div class="card-body p-4 border-bottom">
                            <input type="hidden" name="id" value="<?php echo $notificationData['id']; ?>">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label fw-semibold">Vendeur</label>
                                        <select class="form-select" aria-label="Default select example" name="userID"
                                            required>
                                            <option value="" disabled>Selectionner Client</option>
                                            <?php
                                            // Loop through the users and create options
                                            while ($row = mysqli_fetch_assoc($userDataN)) {
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label fw-semibold">Notification
                                            ID</label>
                                        <input type="text" class="form-control" id="exampleInputtext"
                                            name="notification_id" readonly
                                            value="<?php echo $notificationData['id'] ?>" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputtext"
                                            ...
                                            required><?php echo $notificationData['message'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
