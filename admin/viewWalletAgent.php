...
$sql = "SELECT * FROM agent_withdrawal_requests";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    $table_data = '
            ...
            <td><input type="checkbox" class="row-select form-check-input contact-chkbox primary" value="' . $row['id'] . '"></td>
                ...
                <td>
                    <span
                        class="mb-1 badge font-medium bg-light-info text-info fs-2">' . $row['agent'] . '</span>
                </td>
                <td>
                ...
                <div class="button-group">
                    <a class="btn mb-1 btn-secondary btn-circle btn-sm d-inline-flex align-items-center justify-content-center" href="editTransactionAgent.php?id=' . $row['id'] . '">
...
<head>
    <!--  Title -->
    <title>Admin - Portfeuille Agent</title>
    <!--  Required Meta Tag -->
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="viewWalletAgent.php">List Transactions</a>
                                        </li>
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="addTransactionAgent.php"><button class="btn btn-outline-dark mb-3"><i class="ti ti-plus"
                ...
                <div class="datatables">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title fw-semibold">Histoire des transactions (Agents)</h5>
        ...
        function confirmDelete(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    form.method = "POST";
                    form.action = "deleteTransactionAgent.php"; // Use POST method
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            deleteButton.addEventListener("click", function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        fetch("deleteTransactionsAgent.php", {
                            method: "POST",
