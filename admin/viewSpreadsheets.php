...
$sql = "SELECT user_spreadsheets.*, user_info.full_name
FROM user_spreadsheets
LEFT JOIN user_info ON user_spreadsheets.userID = user_info.id
ORDER BY id;";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    <td>
        <div class="d-flex align-items-center">
            <div class="ms-0">
            <span class="badge bg-light-primary text-primary gap-1 d-inline-flex align-items-center">' . $row['full_name'] . '</span>
            </div>
        </div>
    </td>
    <td>
        <div class="d-flex align-items-center">
            <div class="ms-0">
                <h6 class="fs-4 fw-normal mb-0" id="spreadsheet-id-' . $row['id'] . '">' . $row['spreadsheet_id'] . '</h6>
            </div>
        </div>
    </td>
    <td>  
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">  
                <li>
                    <a class="dropdown-item d-flex align-items-center gap-3 modify-btn" data-id="' . $row['id'] . '" href="javascript:void(0)">
                        <i class="fs-4 ti ti-edit"></i>Modifier ID
                    </a>
                </li>
                ' . $toggle_button . ' <!-- Deactivate or Activate button -->
            </ul>
        </div>
    </td>
</tr>';
                ...
                <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                    <div class="card-body px-4 py-3">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h4 class="fw-semibold mb-8">Feuilles de calcul</h4>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="viewSpreadsheets.php">Feuilles de calcul</a>
                                        </li>
                                        <li class="breadcrumb-item" aria-current="page">Voir feuilles de calcul</li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-3">
                                        ...
                                        <table class="table border text-nowrap customize-table mb-0 align-middle"
                                            ...
                                            <thead class="text-dark fs-4">
                                                <tr>
                                                    ...
                                                    <th>
                                                        <h6 class="fs-4 fw-semibold mb-0">Feuilles de calcul ID</h6>
                                                    </th>
                            ...
                            .then(data => {
                                if (data.success) {
                                    ...
                                    Swal.fire({
                                        icon: "success",
                                        title: "Supprimé!",
                                        text: "Les feuilles sélectionnés ont été supprimés.",
                                        timer: 2000
                                    }).then(() => {
                                    ...
                                    Swal.fire({
                                        icon: "error",
                                        title: "Error",
                                        text: "Impossible de supprimer certains ou tous les feuilles."
                                    });
                                }
                            })
                            .catch(error => {
    ...
    <script>
        ...
        document.querySelectorAll('.toggle-status').forEach(button => {
            button.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    title: 'Es-tu sûr?',
                    text: `Vous êtes sur le point de ${newStatus.toLowerCase()} cette feuille de calcul.`,
                    icon: 'warning',
                    showCancelButton: true,
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = `toggleStatus.php?id=${spreadsheetId}&status=${newStatus}`;
                    }
                });
            });
        });
    ...
    <script>
        ...
        document.querySelectorAll('.modify-btn').forEach(button => {
            button.addEventListener('click', function () {
                ...
                Swal.fire({
                    title: 'Modifier l\'ID de la feuille de calcul',
                    input: 'text',
                    inputLabel: 'Entrez le nouvel ID de la feuille de calcul',
                    ...
                    inputValidator: (value) => {
                        if (!value) {
                            return 'L\'ID de la feuille de calcul ne peut pas être vide';
                        }
                    }
                }).then((result) => {
                    if (result.isConfirmed) {
                        ...
                        xhr.open('POST', 'updateSpreadsheetId.php', true);
                        ...
                        xhr.onreadystatechange = function () {
                            if (xhr.readyState === 4 && xhr.status === 200) {
                                ...
                                if (response.success) {
                                    ...
                                    Swal.fire('Succès!', 'L\'ID de la feuille de calcul a été modifié.', 'success');
                                } else {
