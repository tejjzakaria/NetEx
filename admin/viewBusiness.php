...
// Prepare SQL query to get businesses, ordered by id (latest first)
$sql = "SELECT * FROM businesses ORDER BY id DESC LIMIT ?";
    ...
    $table_data .= '
        <div class="col-lg-6">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">' . $row['business'] . '</h5>
                    <p class="card-text">' . $row['address'] . '</p>
                    <a href="viewBusinessDetails.php?id=' . $row['id'] . '" class="btn btn-primary">More details</a>
                </div>
            </div>
        </div>
    ';
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="viewBusiness.php">List Businesses</a>
                                        </li>
