...
while ($row = $result->fetch_assoc()) {
    if ($row['visibility'] == 'ACTIVE') {
        $visibility_class = "badge bg-success fw-semibold fs-2 mt-2";
        $actions = '
        ...
        $visibility_class = "badge bg-danger fw-semibold fs-2 mt-2";
        $actions = '
    ...
    $table_data .= '
        ...
        <td><input type="checkbox" class="row-select form-check-input contact-chkbox primary" value="' . $row['id'] . '"></td>
            ...
            <td>
                <span class="' . $row['div_class'] . '">' . $row['statut'] . '</span>
            </td>
            
            <td>
                <span class="' . $visibility_class . '">' . $row['visibility'] . '</span>
            </td>
            <td>
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <a href="addStatus.php"><button class="btn btn-outline-dark mb-3"><i class="ti ti-plus"
                            ...
                            .then(data => {
                                if (data.success) {
                                    ...
                                    Swal.fire({
                                        icon: "success",
                                        title: "Supprimé!",
                                        text: "Les statuts sélectionnés ont été supprimés.",
                                        timer: 2000
                                    }).then(() => {
                                    ...
                                    Swal.fire({
                                        icon: "error",
                                        title: "Error",
                                        text: "Impossible de supprimer certains ou tous les statuts."
                                    });
                                }
                            })
                            .catch(error => {
                            ...
                            .then(data => {
                                if (data.success) {
                                    Swal.fire({
                                        icon: "success",
                                        title: "Mis à jour !",
                                        text: "Les statuts sélectionnés ont été mis à jour.",
                                        timer: 2000
                                    }).then(() => {
                                        location.reload();
                                    });
                                    ...
                                    Swal.fire({
                                        icon: "error",
                                        title: "Erreur",
                                        text: "Impossible de mettre à jour certains ou tous les statuts."
                                    });
                                }
                            })
                            .catch(error => {
                ...
                button.addEventListener('click', function (e) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href = `toggleStatuses.php?id=${statusId}&status=${newStatus}`;
                        }
                    });
                });
            });
