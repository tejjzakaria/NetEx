...
$userDataC = mysqli_query($conn, $sql_);
...
$id = $_GET['id'];
$sql = "SELECT * FROM crbt WHERE id='$id'";
$result = mysqli_query($conn, $sql);
$crbtData = mysqli_fetch_assoc($result);

$selectedUserID = $crbtData['userID'];  // Retrieve this from your parcel data
$message = "";
...
if (isset($_POST['submit'])) {
    ...
    $crbt_id = $_POST['crbt_id'];
    $costs = $_POST['costs'];
    $payed_amount = $_POST['payed_amount'];
    $parcels = $_POST['parcels'];
    $status = $_POST['status'];    // Default value
    $comments = $_POST['comments'];

    $parcelsString = implode(',', $parcels);  // For storing as a comma-separated string

    // Update parcel data in the database with error handling
    $sql = "UPDATE crbt SET userID='$userID', payment_date='$payment_date', crbt_id='$crbt_id',
costs='$costs', payed_amount='$payed_amount', parcels='$parcelsString', status='$status', 
                ...
                <div class="card bg-light-info shadow-none position-relative overflow-hidden">
                    <div class="card-body px-4 py-3">
                        <div class="row align-items-center">
                            <div class="col-9">
                                <h4 class="fw-semibold mb-8">CRBTs</h4>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="editCrbt.php">Edit CRBT</a>
                                        </li>
                ...
                <form method="POST">
                    <div class="card">
                        ...
                        <div class="card-body p-4 border-bottom">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                <input type="hidden" name="id" value="<?php echo $crbtData['id']; ?>">
                                    <div class="mb-4">
                                        <label for="" class="form-label fw-semibold">Payment date</label>
                                        <input type="date" class="form-control" id="exampleInputtext"
                                            placeholder="Choose a date" name="payment_date"
                                            value="<?php echo $crbtData['payment_date'] ?>" required>
                                    </div>



                                    <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label fw-semibold">Costs</label>
                                        <input type="number" class="form-control" id="exampleInputtext"
                                            placeholder="Costs here" name="costs"
                                            value="<?php echo $crbtData['costs'] ?>" required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="userID"
                                            ...
                                            while ($row = mysqli_fetch_assoc($userDataC)) {
                                    ...
                                    <div class="mb-4">
                                        <label for="parcels" class="form-label fw-semibold">Parcels</label>
                                        <select class="form-select" aria-label="Select Parcels" name="parcels[]" multiple
                                            required>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label fw-semibold">CRBT
                                            ID</label>
                                        <input type="text" class="form-control" id="exampleInputtext" name="crbt_id"
                                            readonly value="<?php echo $crbtData['crbt_id'] ?>" required>
                                    </div>
                                    <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label fw-semibold">Payed
                                            Amount</label>
                                        <input type="number" class="form-control" id="exampleInputtext"
                                            placeholder="Payed amount here" name="payed_amount" value='<?php echo $crbtData['payed_amount'] ?>'required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="status"
                                            required>
                                            <option value="pending" <?php echo ($crbtData['status'] == 'pending') ? 'selected' : ''; ?>>pending</option>
                                            <option value="failed" <?php echo ($crbtData['status'] == 'failed') ? 'selected' : ''; ?>>failed</option>
                                            <option value="successful" <?php echo ($crbtData['status'] == 'successful') ? 'selected' : ''; ?>>successful</option>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputtext"
                                            placeholder="Add extra info here" name="comments" required><?php echo $crbtData['comments'] ?></textarea>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center gap-3">
                                        <button type="submit" name="submit" class="btn btn-primary">Edit CRBT</button>
                                    </div>
                                </div>
                            </div>
                        </div>
