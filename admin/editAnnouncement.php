...
$type = htmlspecialchars($_POST['type'], ENT_QUOTES, 'UTF-8');
    ...
    $sql = "UPDATE announcements SET message='$message', status='$status', visible_to='$visible_to', type='$type' WHERE id='$id'";
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="">Modifier Annonce</a>
                                        </li>
                ...
                <form method="POST">
                    <div class="card">
                        ...
                        <div class="card-body p-4 border-bottom">
                            <input type="hidden" name="id" value="<?php echo $announcementData['id']; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label fw-semibold">Visible à</label>
                                        <select class="form-select" aria-label="Default select example" name="visible_to"
                                            required>
                                            <option value="" disabled>Sélectionnez une option</option>
                                            <option value="Agents et vendeurs" <?php echo ($announcementData['visible_to'] == 'Agents et vendeurs') ? 'selected' : ''; ?>>Agents et vendeurs</option>
                                            <option value="Agents uniquement" <?php echo ($announcementData['visible_to'] == 'Agents uniquement') ? 'selected' : ''; ?>>Agents uniquement</option>
                                            <option value="Vendeurs uniquement" <?php echo ($announcementData['visible_to'] == 'Vendeurs uniquement') ? 'selected' : ''; ?>>Vendeurs uniquement</option>
                                ...
                                <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label fw-semibold">Statut
                                            ...
                                            required>
                                            <option value="" disabled>Sélectionnez une option</option>
                                            <option value="VISIBLE" <?php echo ($announcementData['status'] == 'VISIBLE') ? 'selected' : ''; ?>>VISIBLE</option>
                                            <option value="INVISIBLE" <?php echo ($announcementData['status'] == 'INVISIBLE') ? 'selected' : ''; ?>>INVISIBLE</option>
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label fw-semibold">Type
                                            ...
                                            required>
                                            <option value="" disabled>Sélectionnez une option</option>
                                            <option value="INFO" <?php echo ($announcementData['type'] == 'INFO') ? 'selected' : ''; ?>>INFO</option>
                                            <option value="WARNING" <?php echo ($announcementData['type'] == 'WARNING') ? 'selected' : ''; ?>>AVERTISSEMENT</option>
                                            <option value="DANGER" <?php echo ($announcementData['type'] == 'DANGER') ? 'selected' : ''; ?>>AVERTISSEMENT ROUGE</option>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputtext"
                                            ...
                                            required><?php echo $announcementData['message'] ?></textarea>
                                    </div>
                                </div>
