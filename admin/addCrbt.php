...
$crbt_id = strtoupper(substr(md5(uniqid(rand(), true)), 0, 10));
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO crbt (userID, payment_date, crbt_id, costs, payed_amount, parcels, status, comments)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param("ssssssss", $userID, $payment_date, $crbt_id, $costs, $payed_amount, $parcelsString, $status, $comments);
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="addCrbt.php">New CRBT</a>
                                        </li>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="date" class="form-control" id="exampleInputtext"
                                            placeholder="Choose a date" name="payment_date" required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" class="form-control" id="exampleInputtext"
                                            placeholder="Costs here" name="costs" required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="userID"
                                            ...
                                            while ($row = mysqli_fetch_assoc($userDataC)) {
                                                ...
                                                echo "<option value='$userID'>$full_name</option>";  // userID as value, full_name as display text
                                            }
                                            ?>
                                        </select>
                                    </div>
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" aria-label="Select Parcels" name="parcels[]"
                                            multiple required>
                                            <option value="">Select User First</option>
                                            <!-- Placeholder before user selection -->
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputtext" name="crbt_id"
                                            readonly value="<?php echo $crbt_id ?>" required>
                                    </div>
                                    <div class="mb-4">
                                        <label for="exampleInputPassword1" class="form-label fw-semibold">Payed
                                            Amount</label>
                                        <input type="number" class="form-control" id="exampleInputtext"
                                            placeholder="Payed amount here" name="payed_amount" required>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea type="text" class="form-control" id="exampleInputtext"
                                            placeholder="Add extra info here" name="comments" required></textarea>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center gap-3">
                                        <button type="submit" name="submit" class="btn btn-primary">Add CRBT</button>
                                    </div>
                                </div>
                            </div>
                        </div>
