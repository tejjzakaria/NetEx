...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO parcels2 (userID, name, tracking_id, phone_number, price, city, product, address, comments, status, state, agent)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    $stmt->bind_param("ssssssssssss", $userID, $name, $tracking_id, $phone_number, $price, $city, $product, $address, $comments, $status, $state, $agent);
...
<head>
    <!--  Title -->
    <title>Admin - Ajouter Colis</title>
    <!--  Required Meta Tag -->
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a class="text-muted " href="addParcels.php">Ajouter Colis</a>
                                        </li>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control mt-2" id="lastName1" name="name"
                                            placeholder="Entrer le nom du destinaire" required />
                                    </div>
                                    <div class="mb-4">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        <label for="exampleInputPassword1"
                                            ...
                                            placeholder="Entrer prix de produit" required />
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="status"
                                            ...
                                            <option value="returné">returné</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="d-flex align-items-center gap-3">
                                        <button type="submit" name="submit" class="btn btn-primary">Ajouter colis</button>
                                    </div>
                                </div>
                            </div>
                        </div>
